...
def main(title, num = 3):
    parser = argparse.ArgumentParser()
    parser.add_argument('--device', default='0,1,2,3', type=str, required=False, help='设置使用哪些显卡')
    parser.add_argument('--length', default=150, type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--model_config', default='GPT2_Chinese/model/txt/config.json', type=str, required=False,
                        help='模型参数路径')
    parser.add_argument('--tokenizer_path', default='GPT2_Chinese/model/txt/vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_path', default='GPT2_Chinese/model/txt', type=str, required=False, help='模型路径')
    parser.add_argument('--save_path', default='GPT2_Chinese/generated/', type=str, required=False, help='存放生成的文件的路径')
    parser.add_argument('--articles_per_title', default=num, type=int, required=False, help='每个标题生成多少篇文章')
    parser.add_argument('--titles', default=title, type=str, required=False, help='标题列表，是一个字符串，用空格分开')
    ...
    if args.segment:
        from GPT2_Chinese.tokenizations import tokenization_bert_word_level as tokenization_bert
    else:
        from GPT2_Chinese.tokenizations import tokenization_bert
